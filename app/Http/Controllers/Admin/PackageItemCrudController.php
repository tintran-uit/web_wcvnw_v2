...
class PackageItemCrudController extends CrudController
{
    ...
    public function setUp()
    {
		...
		|--------------------------------------------------------------------------
		*/
        $this->crud->setModel("App\Models\PackageItem");
        $this->crud->setRoute(config('backpack.base.route_prefix', 'admin').'/package-item');
        $this->crud->setEntityNameStrings('packageitem', 'packageitems');
...
//        $this->crud->setFromDb();
        ...
        // $this->crud->addClause('where', 'category', 0);        
