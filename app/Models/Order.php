...
class Order extends Model
{
	...
	*/
    ...
    protected $fillable = ['id', 'order_id', 'customer_id', 'shipper_id','rating_service', 'rating_customer', 'note','status', 'shipping_cost', 'delivery_phone', 'delivery_address','delivery_district'];
    // protected $hidden = [];
    // protected $dates = [];
    /*protected $casts = [
        'featured'  => 'boolean',
