...
class Order extends Model
{
	...
	*/
    ...
    protected $fillable = ['id', 'order_id', 'customer_id', 'shipper_id','rating', 'note','status', 'shipping_cost', 'delivery_phone', 'delivery_name', 'delivery_address','delivery_district', 'total', 'payment', 'language'];
    // protected $hidden = [];
    // protected $dates = [];
    /*protected $casts = [
        'featured'  => 'boolean',
