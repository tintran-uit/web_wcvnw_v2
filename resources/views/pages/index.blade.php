               ...
               $.each(data, function(index, data){ 
                  ...
                  $.each(data, function(i, d){
                     ...
                     if(d.quantity_left==0){
                        prodHtml = '<article class=\"col-xs-6 col-sm-4 col-lg-3\" style=\"\">\r\n                           <div class=\"relative\">\r\n                              <div class=\"ribbon ribbon-new\">\r\n                                 '+createLabel(d.label)+'                              <\/div>\r\n                                                           <div class=\"content-product\">\r\n                                 <div class=\"thumbnail\">\r\n                                    <figure class=\"image-product\">\r\n                                       <div class=\"btn-view\">\r\n                                          <a class=\"white\" href=\"product/slug='+d.slug+'\">    <i class=\"fa fa-search\"><\/i>\r\n                                          <\/a>\r\n                                       <\/div>\r\n                                       <a class=\"center-block\" href=\"/product/slug='+d.slug+'\">        <img class=\"img-responsive center-block small-img\" alt=\"product\" src=\"{{url('')}}/'+d.thumbnail +'\" \/>\r\n  <div class="reported-out-of-stock text-center">{{ trans('head.soldOut') }}!</div>\r\n                         <\/a>    \r\n                                    <\/figure>\r\n                                    <div class=\"caption text-center\">\r\n                                       <article class=\"copy\">\r\n                                          <h4 class=\"no-margin-top\"><a class=\"new-price\" href=\"product/slug='+d.slug+'\">'+d.name + ' '+d.unit_quantity+d.unit+'</a><\/h4>\r\n                                          \r\n                                          <p>\r\n                                       <\/article>\r\n                                       <article class=\"price\">\r\n                                                            <a href=\"{{url('')}}/nong-trai-sach/farmer_id='+d.farmer_id+'\"><span class=\"new-price\"> '+d.farmer_name+'                                          <\/span></a>\r\n                                       <\/article>\r\n                                            <article class=\"button-group clearfix\">\r\n                                           <div class=\"pull-left vcenter\">\r\n                                             <a class=\"btn btn-danger disabled no-margin\" onclick=\"addCart(\''+d.id+'\','+d.farmer_id+')\">{{ trans('head.soldOut') }}\r\n  <\/a>        \r\n  <\/div>\r\n ';
                     }

                     if(index==0){
                      prodHtml += '<div class=\"pull-right vcenter\"><span class=\"span-price\">'+numberWithCommas(d.price)+' VND  <\/span><br>\r\n'+'{{ trans('head.retail') }}'+':\r\n<span class=\"\" style=\"font-size: 13px;text-decoration: line-through;\">'+numberWithCommas(d.price_old)+' VND  <\/span> <\/div>';
                     }else{
                      prodHtml += '<div class=\"pull-right vcenter\">\r\n<span class=\"span-price\">'+numberWithCommas(d.price)+' VND  </span>     \r\n      <\/div>';
                     }
                     prodHtml += '\r\n<\/article>\r\n                                    <\/div>\r\n                                 <\/div>\r\n                              <\/div>\r\n                           <\/div>\r\n                        <\/article>';
