               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="treeview active">
                     ...
                     <ul class="treeview-menu">
                        <li class="{{ Request::is('farmer/dashboard') ? 'active' : '' }}"><a href="{{url('')}}/admin/agent-item"><i class="fa fa-user-o"></i> <span>Thống kê đơn hàng</span></a></li>
                        <li class="{{ Request::is('farmer/sell') ? 'active' : '' }}"><a href="{{url('')}}/admin/shipper-item"><i class="fa fa-address-card"></i> <span>Đăng bán</span></a></li>
                     </ul>
                  </li>
